...
delta_y1 = (vy_fit1[1:] - vy_fit1[0:-1])
vy1 = delta_y1 * 60
ay1 = (vy2[1:] - vy2[:-1]) * 60
```
...
```{code-cell} ipython3
# 1D Plot the polyfit lines for velocity and position (2 figures) with the finite difference velocity data points and positions. 
# Which lines look like better e.g. which line fits the data?
